...
export const EditorData = () => (
  <div>
    <h3>
      Explore Custom Web Solutions: As a freelance developer, I specialize in
      building dynamic, user-friendly web applications tailored to your business
      needs. Whether you're looking to enhance your website's interactivity,
      streamline user experience, or create a custom platform from scratch, I
      provide tailored solutions that grow with your project. Why Choose Me?
      With 2 years of experience in modern web technologies like React, I can
      seamlessly integrate advanced features while keeping your site responsive
      and scalable. I offer a range of services from quick adjustments to
      full-scale application development, ensuring that your site stays ahead in
      functionality and design. See the Code in Action: Want a Play around with
      this live editor to explore some of the features of this website.Get
      Started Today: If you're ready to take your web presence to the next
      level, let’s chat. I’d love to discuss how I can help you achieve your
      goals, from custom web development to optimizing existing projects.
      Contact me now to get started on bringing your vision to life.
    </h3>
  </div>
);
